...
class Surname
{
    ...
    public const SINGLE = [
        ...
        '年', '爱', '阳', '佟', '商', '牟', '佘', '佴', '伯', '赏','肖','信','渠','兰','凡','邱','来',
        '邳','果','南','占','揣','闫','付','绳','息','豆','菅','闵'
    ];

    // compound surname
    public const COMPOUND = [
    ...
    public static function check($username): bool
    {
        $firstName  = utf8sub($username, 1);
        $doubleName = utf8sub($username, 2);

        return in_array($firstName, self::SINGLE) || in_array($doubleName, self::COMPOUND);
    }
}
